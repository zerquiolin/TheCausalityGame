...
class SCMEstimationMission(Mission):
    """
    Mission for discovering the underlying Structural Causal Model (SCM) from data.

    This mission evaluates how well an agent estimates the correct Structural Causal Model
    true underlying structure derived from the Structural Causal Model.
    The deliverable is expected to be a 'EstimatedANMSCM' object representing the
    agent's estimated SCM.
    ...
    def __init__(  # noqa: PLR0913
        ...
        id: str = "scm_estimation_mission",
        name: str = "SCM Estimation Mission",
        description: str = (
            "This mission evaluates the ability to discover the Structural Causal Model from data."
        ),
    ) -> None:
        super().__init__(
    ...
    @classmethod
    @override
    def from_spec(cls, spec: MissionSpec) -> SCMEstimationMission:
        return cls(
            id=spec.id,
