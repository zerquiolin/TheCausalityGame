...
class ExperimentSpec:
    ...
    interventions: Optional[Mapping[str, Any]]
    n: int
...
ExperimentTuple = Tuple[Optional[Mapping[str, Any]], int]
...
class Decision:
    ...
    @classmethod
    def experiment(
        cls, *items: Union[ExperimentLike, Iterable[ExperimentLike]]
    ) -> "Decision":
    ...
    def add_experiment(
        self, interventions: Optional[Mapping[str, Any]], n: int
    ) -> "Decision":
