...
\paragraph{PlotManager}  generates visual artifacts post-hoc (e.g.\ at game or benchmark end), never visible to the agent during play, ensuring causal purity.\me{This might be deleted.}[1]
